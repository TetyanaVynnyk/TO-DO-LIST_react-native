...
import data from './components/tasks.json'
...
//        this.setState({ pressed: true, color: 'red', color2: 'black'});
//     } else {
//       this.setState({ pressed: false, color: 'black' , color2: 'red'});
//   }
// };
...
{/* key={index} style={{color:this.state.color}} onPress={()=>changeColor(index)} */}
